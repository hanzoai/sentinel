...
export default function AddInstallationInstructions() {
  return (
    <Fragment>
      <p>
        {tct(
          'The automated AWS Lambda setup will instrument your Lambda functions with Sentinel error and performance monitoring without any code changes. We use CloudFormation Stack ([learnMore]) to create the Sentry role which gives us access to your AWS account.',
          {
            learnMore: (
