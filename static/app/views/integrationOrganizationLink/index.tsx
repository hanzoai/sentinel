...
> {
  ...
  renderCallout() {
    ...
    const alertText = tct(
      `GitHub user [sender_login] has installed GitHub app to [account_type] [account_login]. Proceed if you want to attach this installation to your Sentinel account.`,
      {
