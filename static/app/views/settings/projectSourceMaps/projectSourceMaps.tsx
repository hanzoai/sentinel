...
export function ProjectSourceMaps({location, router, project}: Props) {
  ...
  return (
    <Fragment>
      ...
      <TextBlock>
        {tct(
          `These source map archives help Sentinel identify where to look when Javascript is minified. By providing this information, you can get better context for your stack traces when debugging. To learn more about source maps, [link: read the docs].`,
          {
            link: (
